...
{
    public class CreateSignalViewModel : ViewModelBase
    {
        private int _id;
        ...
        private const string _additionalInformation = "(Leave 0 if you don't want to specify the Id)";
        ...
        public CreateSignalViewModel(SignalsStore signalsStore, NavigationService signalViewNavigationService)
        {
            _signalsStore = signalsStore;
            _date = DateTime.Now;

            SubmitCommand = new CreateSignalCommand(signalsStore, this, signalViewNavigationService);
